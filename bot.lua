...
----config----
local bot_api_key = "258094986:AAFxgB_RsFwvbtkJsVImt4EvkphtfvD0WTw"
local You = 233477700
...
local function do_keyboard_private()
    ...
    {
    	{text = '#mr_dany Channel 🇮🇷', url = '@black_wish'},
			{text = '#mr_dany 🌐WEBSITE' , url = 'http://www.aparat.com'}
	    }, 
		{
			{text='👤PV SUDO',url='http://telegram.me/Zendgim_fatemeh'},
		},
    }
    return keyboard
end
